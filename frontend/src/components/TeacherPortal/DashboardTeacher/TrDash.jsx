        ...
        <div class="flex gap-8 maindiv">
          ...
          <div class="w-2/3 flex flex-col gap-5 mb-0 leftdiv1">
            ...
            <div class="flex gap-4 cardsec1">
              ...
              {/* <!-- Card 2 --> */}
              <div
                class="w-64 bg-white flex border-2 border-[rebeccapurple] flex-col items-center text-center rounded-2xl p-6 shadow-2xl"
              >
                <img
                  class="mb-4"
                  src="/Group 14.png"
            ...
            <div class="flex justify-between items-center px-2">
              ...
              <h4 class="text-[rebeccapurple] font-bold cursor-pointer">See all</h4>
            </div>
            ...
            <div class="flex gap-4 cardsec2">
              ...
              >
                {/* <!-- left div --> */}
                <div>
                  <h4 class="text-lg text-[rebeccapurple] font-bold mb-5">
                    Python Programming
                  </h4>
                  <button
                    class="px-7 py-1 font-bold mb-2 bg-[rebeccapurple] text-white rounded-full"
                  >
                    Veiw
                  </button>
                </div>
              ...
              >
                ...
                <div>
                  ...
                  <button
                    class="px-7 mb-2 py-1 font-bold bg-[rebeccapurple] text-white rounded-full"
                  >
                    Veiw
                  </button>
                </div>
          ...
          <div class="w-1/3 rightdivP">
            ...
            <div class="flex flex-col gap-5 px-2">
              ...
              <div class="flex items-center gap-4">
                {/* <!-- Avatar 1 --> */}
                <div
                  class="border-2 border-[rebeccapurple] overflow-hidden rounded-full"
                >
                  <img
                    class="w-14 h-14"
