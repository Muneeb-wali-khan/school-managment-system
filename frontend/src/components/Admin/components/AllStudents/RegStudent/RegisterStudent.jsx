...
import { adminFetchAllStudents, adminRegisterStudent, clearErrorStudents } from "../../../../../store/features/admin.reducers";
...
const RegisterStudent = () => {
  ...
  const { loadingSt, errSt, msgSt } = useSelector(
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(adminRegisterStudent(formdata))
  };
